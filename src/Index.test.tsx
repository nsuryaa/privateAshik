...
describe("application tests", () => {
  ...
  it("should render name: Mohamed Ashik", () => {
    const element = screen.getByTestId("name");

    checkContent(element, /^Mohamed Ashik$/, undefined, true);
  });
  ...
  it("should render creator", () => {
    ...
    checkContent(element, /^Mohamed Ashik$/, "");
  });
  ...
  it("should render GitHub button", () => {
    ...
    checkButton(parent, child, /^GitHub$/, "https://github.com/Ashik2609");
  });
  ...
  it("should render LinkedIn button", () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      "http://linkedin.com/in/mohamed-ashik-"
    );
  });
  ...
  it("should render Resume button", () => {
    ...
    checkButton(
      ...
      child,
      /^Resume$/,
      "https://drive.google.com/file/d/1-EaHtuZMAJYoKL_Nq2FE4V7xHuP8QHRV/view"
    );
  });
  ...
  it("should render full footer on desktop", () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Mohamed Ashik \| Source$/
    );
  });
});
...
describe("app context tests", () => {
  it("should render partial footer on mobile", async () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Mohamed Ashik$/);
